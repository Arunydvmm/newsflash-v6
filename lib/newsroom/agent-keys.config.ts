export const AGENT_KEYS = {
  ...
  EXTRACT_VERIFY: {
    primary: { key: process.env.GROQ_KEY_1!,        provider: 'groq',       model: 'llama-3.3-70b-versatile' },
    backup:  { key: process.env.OPENROUTER_KEY_3!,  provider: 'openrouter', model: 'meta-llama/llama-3.3-70b-instruct:free' }
  },
  WRITE: {
  ...
  SAFETY: {
    primary: { key: process.env.OPENROUTER_KEY_3!,  provider: 'openrouter', model: 'meta-llama/llama-3.3-70b-instruct:free' },
    backup:  { key: process.env.OPENROUTER_KEY_4!,  provider: 'openrouter', model: 'meta-llama/llama-3.3-70b-instruct:free' }
  },
  SEO_POLISH: {
  ...
  CHIEF_EDITOR: {
    primary: { key: process.env.OPENROUTER_KEY_2!,  provider: 'openrouter', model: 'meta-llama/llama-3.3-70b-instruct:free' },
    backup:  { key: process.env.GROQ_KEY_1!,        provider: 'groq',       model: 'llama-3.3-70b-versatile' }
  }
}
...
export const KEY_SHARING_MAP: Record<string, string[]> = {
  'GROQ_KEY_1':       ['MONITOR_primary', 'MONITOR_backup', 'RESEARCH_primary', 'EXTRACT_VERIFY_primary', 'SEO_POLISH_backup', 'CHIEF_EDITOR_backup'],
